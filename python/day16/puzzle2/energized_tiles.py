...
def cast_beam(from_i, from_j, direction, map_lines, map_cols, size):
    n = size[0]
    m = size[1]
    ...
    cast_beam_rec(from_i, from_j, direction, map_lines, map_cols, energized_tiles, size)
...
def print_energized_tiles(energized_tiles):
...
if __name__ == '__main__':
    ...
    energized_tiles = cast_beam(9, 7, 'up', map_lines, map_cols, size)
    print(count_energized_tiles(energized_tiles))
    print_energized_tiles(energized_tiles)
